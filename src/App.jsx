        ...
        <div className="flex justify-center items-center overflow-hidden">
          ...
          <div ref = {thumbnails} style={thumbnails_style}>
            ...
            {clonesLeft.map((src, index) => (
              <div key={`cloneLeft-${index}`} className="flex-none w-1/3 p-1">
                <img className="thumbnail-img-clone p-1 m-1" src={src}/>
              </div>
            ))}
            ...
            {clonesRight.map((src, index) => (
              <div key={`cloneRight-${index}`} className="flex-none w-1/3 p-1">
                <img className="thumbnail-img-clone p-1 m-1" src={src}/>
              </div>
            ))}
