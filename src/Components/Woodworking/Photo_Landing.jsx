...
export default function Landing() {
  ...
  const { woodURL } = useParams()
  const matchedAlbum = albumsData.find((album) => album.url === woodURL)
            ...
            <>
              ...
              <div>
                <div className="photo-landing-mobile-title-year flex flex-col p-6">
                  <div className="photo-landing-mobile-title uppercase">
                    {matchedAlbum.title}
                  </div>
              ...
              <div className="photo-landing-info-wrapper flex justify-center">
                ...
                >
                  ...
                  <div className="photo-landing-info flex flex-col p-6">
                    <div className="photo-landing-info-title uppercase">
                      {matchedAlbum.title}
                    </div>
                    <div className="photo-landing-info-year">
                      {matchedAlbum.year}
                    </div>
                    <div className="photo-landing-info-time flex items-center gap-1">
                      {`${matchedAlbum.dimensions}`}
                    </div>
                    <div className="photo-landing-info-time mb-8 flex items-center gap-1">
                      {`${matchedAlbum.materials}`}
                    </div>
